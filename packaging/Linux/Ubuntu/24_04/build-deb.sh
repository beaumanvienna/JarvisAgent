...
if [[ -d "$REPO_ROOT/code/frontend/dashboard/ui/dist" ]]; then
    cp -r "$REPO_ROOT/code/frontend/dashboard/ui/dist" "$INST/dashboard/ui/dist"
else
...
if [[ -d "$REPO_ROOT/code/frontend/workflow-editor/ui/dist" ]]; then
    cp -r "$REPO_ROOT/code/frontend/workflow-editor/ui/dist" "$INST/workflow-editor/ui/dist"
else

...
3. Register cloud connectors and task executors (see `code/backend/application/cloud/README.md`)
...
- cloud task executors — see `code/backend/application/cloud/README.md`

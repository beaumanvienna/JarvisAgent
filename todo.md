...
- **Editor UX review** — synthesise the F-5…F-42 findings into the three root-cause themes (data-carrying edges, artifact-file nodes, hide `../` traversals) → a node/edge/artifact redesign.  Scoped in the plan's "Editor UX review" section.

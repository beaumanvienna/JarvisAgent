...
- Serve the dashboard UI (`dashboard/ui/dist`)
- Serve the workflow editor UI (`workflow-editor/ui/dist`)
...
| Route | Serves |
|-------|--------|
| `/` | Dashboard (`dashboard/ui/dist/index.html`) |
| `/editor` | Workflow editor (`workflow-editor/ui/dist/index.html`) |
